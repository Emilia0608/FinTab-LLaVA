nohup python -m llava.eval.model_vqa \
    ...
    --answers-file /home/work/skku_train/jj/result/experiment_2/dk_first_TD_heldin_both_answer_sample1000.jsonl \
    --num-chunks 1 \
    --chunk-idx 0 \
    --temperature 0 \
    --conv-mode v1 > logs/dk_first_TD_heldin_both.txt 2>&1 
